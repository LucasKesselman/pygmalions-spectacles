...
export default class LevelManager {
    ...
    LoadLevelEnvironment(levelScene, levelID) {
    ...
    LoadLevelDebugTools(levelScene) {
    ...
    LoadPlayerCharacter(levelScene) {
        // ~ Player Character
    ...
    LoadLevelCamera(levelScene, engine, levelID) {
